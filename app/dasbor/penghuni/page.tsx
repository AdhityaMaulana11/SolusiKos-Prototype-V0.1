...
import { formatRupiah, getProperty, getUser, providerServices } from "@/lib/mock-data"
...
export default function TenantDashboard() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <DashboardShell>
        {/* Summary / Ringkasan */}
        {(tab === "ringkasan" || !["booking", "pembayaran", "layanan", "notifikasi"].includes(tab)) && (
              ...
              {userServices.length === 0 ? (
                ...
                <div className="flex flex-col gap-3">
                  {userServices.map((sr) => {
                    ...
                    return (
                      <div key={sr.id} className="flex items-center justify-between rounded-lg border border-border p-4">
                        <div>
