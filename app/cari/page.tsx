...
export default function SearchPage() {
  ...
  const results = useMemo(() => {
    ...
    return filtered
  }, [state.properties, query, selectedRegion, selectedType, priceRange, sortBy])
  ...
  const hasActiveFilters = query || selectedRegion || selectedType || priceRange[0] > 0 || priceRange[1] < 3000000
          ...
          <div className="mb-6 rounded-lg border border-border bg-card p-4">
            <div className="flex flex-wrap gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground">Wilayah</label>
                <select
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground">Tipe Kamar</label>
                <select
                  value={selectedType}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground">Harga Minimum</label>
                <select
                  value={priceRange[0]}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-foreground">Harga Maksimum</label>
                <select
                  value={priceRange[1]}
